...
const Home: React.FC = () => {
  return (
    <div className="flex h-screen flex-col items-center overflow-y-scroll py-[150px] pt-16 lg:mx-28 lg:overflow-hidden lg:pb-0">
      <NavTop />
      <NavTopdesk />
      ...
      <main className="flex w-full flex-row justify-center">
        <div className="flex lg:w-[70vw] ">
          ...
          <div className="flex w-full flex-col scrollbar-none lg:h-[90vh] lg:overflow-y-scroll">
            <div className="flex w-full flex-col overflow-hidden scrollbar-none lg:h-[90vh] lg:overflow-y-scroll">
